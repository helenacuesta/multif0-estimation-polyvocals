...
class Data(object):
    ...
    def get_train_generator(self):
        ...
        """
        return utils.data_generator(
            self.train_files, self.input_patch_size, self.files_batch, self.batch_size)

    def get_validation_generator(self):
        """return a training data generator
        """
        return utils.data_generator(
            self.validation_files, self.input_patch_size, self.files_batch, self.batch_size)

    def get_test_generator(self):
        """return a training data generator
        """
        return utils.data_generator(
            self.test_files, self.input_patch_size, self.files_batch, self.batch_size)
